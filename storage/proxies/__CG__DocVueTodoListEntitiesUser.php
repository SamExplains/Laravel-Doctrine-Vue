 ...
 */
class User extends \DocVueTodoList\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DocVueTodoList\\Entities\\User' . "\0" . 'id', '' . "\0" . 'DocVueTodoList\\Entities\\User' . "\0" . 'name', '' . "\0" . 'DocVueTodoList\\Entities\\User' . "\0" . 'email', '' . "\0" . 'DocVueTodoList\\Entities\\User' . "\0" . 'tasks', 'password', 'rememberToken'];
        }
     ...
     * {@inheritDoc}
     */
    public function addTask(\DocVueTodoList\Entities\Task $task)
    {
